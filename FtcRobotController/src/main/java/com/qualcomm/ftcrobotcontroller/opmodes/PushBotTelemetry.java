...

{
...

    {
        ...
        //
        telemetry.addData ("06", "GP1 Left: " + -gamepad1.left_stick_y);
        telemetry.addData ("07", "GP1 Right: " + -gamepad1.right_stick_y);
        telemetry.addData ("08", "GP2 Left: " + -gamepad2.left_stick_y);
